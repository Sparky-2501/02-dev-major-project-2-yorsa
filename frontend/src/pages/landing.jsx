...
export default function LandingPage() {
    ...
    // Carousel auto-advance every 6s
    useEffect(() => {
    ...
    const handleStartInstantMeeting = async () => {
        ...
        try {
            const res = await axios.post(`${server}/api/meetings/create`, {
                ...
                hostId: localStorage.getItem("lastUsername") || "Host"
            });
    ...
    return (
        <div style={{
            ...
            {/* Google Meet Modern Navigation Bar */}
            <header style={{
                display: 'flex',
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    <span style={{ fontSize: '0.95rem', color: 'var(--text-secondary, #9aa0a6)', fontWeight: 400 }} className="landing-clock">
                        {currentTime}
                    </span>
                    ...
                    >
                        ...
                        <span className="landing-clock">History</span>
                    </button>
            ...
            {/* Google Meet Hero Split Section */}
            <main style={{
                flex: 1,
                display: 'grid',
                ...
                <div style={{ maxWidth: '580px' }}>
                    ...
                    <p style={{
                        ...
                        Connect, collaborate, and synthesize with Yorsa Meet. Equipped with privacy-first opt-in AI notetaking, interactive mind maps, and host security controls.
                    </p>

                    {/* Google Meet Action Bar */}
                    <div style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: '16px',
                        ...
                        >
                            ...
                            <MenuItem onClick={handleStartInstantMeeting} style={{ gap: '10px', fontSize: '0.9rem', padding: '12px 18px' }}>
                                <VideocamIcon fontSize="small" style={{ color: '#8ab4f8' }} />
                                Start an instant meeting
                            </MenuItem>
                        </Menu>

                        {/* Meeting Code Input Box */}
                        <form onSubmit={handleJoin} style={{
                            ...
                            <button
                                ...
                                style={{
                                    background: 'transparent',
                                    border: 'none',
                                    color: meetingInput.trim() ? '#8ab4f8' : 'var(--text-muted, #80868b)',
                                    fontWeight: 600,
                                    fontSize: '0.9rem',
                                    cursor: meetingInput.trim() ? 'pointer' : 'default',
                                    padding: '4px 8px'
                                }}
                            >
                                Join
                    ...
                    <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                        <a
                            ...
                            style={{ color: '#8ab4f8', fontSize: '0.9rem', textDecoration: 'none', fontWeight: 500 }}
                        >
                            View saved meeting summaries & mind maps →
                        </a>
                    </div>
                </div>

                {/* Right Column: Google Meet Interactive Showcase Carousel */}
            ...
            {/* Invite Modal for "Create meeting for later" */}
            <InviteModal
            ...
            <footer style={{
                ...
                Yorsa Meet • Built with WebRTC and Hugging Face AI • Google Meet Inspired UI
            </footer>
